...
test_loader_classifier = DataLoader(test_dataset_classifier, batch_size=8, shuffle=False)
...
def evaluate(loader):
    ...
    report = classification_report(all_labels, all_preds, target_names=["No Hole", "Hole"])
